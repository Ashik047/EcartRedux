            ...
            <div className='container px-10 w-full pt-[40px] grow'>
                ...
                <div className='grid grid-cols-4 gap-4'>
                    <div className='rounded border border-black shadow w-full'>
                        <img src="https://images.pexels.com/photos/90946/pexels-photo-90946.jpeg?cs=srgb&dl=pexels-madebymath-90946.jpg&fm=jpg" alt="prodcut" className='w-full h-[200px] mb-4 object-cover' />
